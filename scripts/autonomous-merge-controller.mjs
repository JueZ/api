    ...
    input: [
      {
        ...
        content: [
          ...
          'Keep the analysis concise and reserve at least 512 output tokens for the final structured JSON decision.',
      ...
      },
      {
        ...
        content: JSON.stringify({
          ...
          untrustedReviewDiff: reviewDiff.diff,
        }),
      },
    ],
  };
...
export function buildReviewDiffCapsule(sourceDiff, risk, changedPaths) {
  ...
  const reviewedPaths = uniqueChangedPaths;
