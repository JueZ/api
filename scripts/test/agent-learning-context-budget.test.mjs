...
test('routine agent context stays bounded and excludes historical ledgers', () => {
  ...
  assert.doesNotMatch(source('AGENTS.md'), /quality-10|agent-learning\/program|evidence ledger/i);
});
