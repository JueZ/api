...
export const requiredManagedSettingNames = [
  ...
  'YOUTUBE_TRANSCRIPT_STORAGE_ACCOUNT_NAME',
  'YOUTUBE_TRANSCRIPT_CONTAINER',
...
export function buildExpectedRuntimeSettings(env = process.env) {
  ...
  return {
    ...
    YOUTUBE_TRANSCRIPT_ENABLED: value(env, 'YOUTUBE_TRANSCRIPT_ENABLED', 'false'),
    SUPADATA_API_KEY: value(env, 'EXPECTED_SUPADATA_API_KEY_REFERENCE'),
    YOUTUBE_TRANSCRIPT_CURSOR_HMAC_KEY: value(env, 'EXPECTED_YOUTUBE_CURSOR_HMAC_KEY_REFERENCE'),
    YOUTUBE_TRANSCRIPT_STORAGE_ACCOUNT_NAME: privateStorage,
    YOUTUBE_TRANSCRIPT_CONTAINER: value(env, 'YOUTUBE_TRANSCRIPT_CONTAINER', 'youtube-transcripts'),
    YOUTUBE_TRANSCRIPT_CACHE_TTL_SECONDS: value(env, 'YOUTUBE_TRANSCRIPT_CACHE_TTL_SECONDS', '86400'),
