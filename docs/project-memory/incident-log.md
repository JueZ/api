...
- Validation status: the scoped repair passes refreshed formatting/ESLint, targeted workflow/runtime regressions, the full 262-test suite, policy/agent-skill checks, Bicep, workflow YAML parsing, Actionlint, and ShellCheck. The final permitted exact-head GitHub review and live test acceptance remain required. Production remains unchanged.
