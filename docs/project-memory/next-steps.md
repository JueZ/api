...
- Bootstrap PR #274 repaired the trusted reviewer. Focused runtime/bootstrap/settings PR #275 and successors #276/#277/#278 each exhausted two bounded high-risk reviews without bypass. A fresh successor carries the accumulated package-only rollback, attempt rejection, correlation-bound artifact/provenance, exact rendered-frontend and destination inventory, complete safety-policy, idempotent trigger, and exact CI authorization repairs.
