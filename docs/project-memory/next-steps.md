...
1. Deliver the budget-date successor that preserves the existing Azure budget start date across monthly rollovers without deleting or recreating the €10 test budget.
