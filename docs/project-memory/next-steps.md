...
- Phase 2 implementation PR #349 merged as `9310c94f97541e57f83b186af2cacf989d6f5330`; trusted-primitives PR #367 merged as `697cf2065666c0b384b13ea166ea57933b13bc03`; evidence-orchestration PR #369 merged as `8e1ab87efbedbc02075e820a13b98721423be710`; controller-wiring PR #371 merged as `8f71efebfa317853a89970eec4527bde696e277a`. Each completed its recorded exact-head and terminal delivery/runtime evidence.
- Deliver the current Phase 2 evidence PR with `docs/agent-learning/evidence/phase-2-versioned-artifacts.json` while the phase remains `in_progress`. The newly installed protected-main verifier must authenticate the exact candidate/review/controller identities, complete historical implementation evidence, stable histories, exact delivery workflows/jobs/artifacts/digests, current protected main, live test/production health, and both current ledgers before merge.
- After that PR completes protected merge, main CI, Deploy Test, Promote Production, smoke, telemetry, ledgers, and fresh runtime truth, open one minimal protected ledger PR to record those exact references and change Phase 2 to `accepted`. Only after that ledger PR reaches terminal evidence may Phase 3 begin. A local schema pass, a Markdown status change, or a merged PR alone is insufficient evidence.
- Keep issues #351, #355, #356, #359, #360, #361, #365, #368, #370, and #373 open as the current learning-implementation backlog; do not manufacture retroactive Phase 3 rollout evidence. Retain the unchanged `$0.31` review ceiling, keep capsules below 140,000 diff bytes, and keep Phase 4 task-evaluation aliases fail closed until their owning phase.
