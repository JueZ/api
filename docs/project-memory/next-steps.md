...
- Phase 2 implementation PR #349 merged as `9310c94f97541e57f83b186af2cacf989d6f5330`; trusted-primitives PR #367 merged as `697cf2065666c0b384b13ea166ea57933b13bc03`; orchestration PR #369 merged as `8e1ab87efbedbc02075e820a13b98721423be710`; controller wiring PR #371 merged as `8f71efebfa317853a89970eec4527bde696e277a`; required-aggregate PR #378 merged as `f56422021640b34be2588c33999f63b59a87399a`. Each completed its recorded terminal delivery/runtime evidence, but Phase 2 remains `in_progress`.
...
- PR #381 passed every free aggregate but its single bounded review request returned sanitized HTTP 429 `credit_balance_exhausted`; the required aggregate failed and the PR closed without rerun. Issues #380 and #382 own the retry-guidance and external-capacity fingerprints.
- Keep `codex/autonomous-review-capacity-gate` local until explicit operator confirmation that usable capacity for the existing review project is restored. Then set `AUTONOMOUS_REVIEW_CAPACITY_READY=true`, make one deliberate protected push, and deliver the combined rerun-guidance/circuit-breaker capsule through terminal evidence. Afterwards use one protected PR both to verify the two artifacts and register public-safe Phase 2 evidence, followed by one post-evidence Phase 2 acceptance-ledger PR before starting Phase 3. Do not inspect or replace the shared key, create a no-op head, or weaken any verifier or gate; keep task-evaluation aliases fail closed until Phase 4.
