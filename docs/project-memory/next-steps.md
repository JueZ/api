...
- Phase 2 implementation PR #349 merged as `9310c94f97541e57f83b186af2cacf989d6f5330` and completed staged delivery/runtime verification, but the phase remains `in_progress`. Evidence PRs #350 and #352 and trusted-verifier foundation PR #354 closed unmerged after exhausting their repair limits; learning issues #351, #355, and #356 record the required durable follow-up.
- Next, deliver one fresh trusted-verifier successor from protected main. Retain the complete #354 boundary: tokenless PR CI; authenticated protected-main controller code; inert fixed-path candidate data; exact head, review, check, run, deployment, job, artifact, digest, ledger, and runtime binding; fixed runtime hosts; redirects disabled; bounded reads; and the existing aggregate, rollup, permission, and delivery controls.
- Add immutable Phase 2 constants for PR #349, baseline `eab88f735d3644181d2a043156970f0df02e3ff8`, branch `codex/agent-learning-phase-2-artifacts`, head `7188188cc0b3fd1a58a5ee14ae5335158294135c`, and merge `9310c94f97541e57f83b186af2cacf989d6f5330`. Add negative tests for otherwise-valid evidence with each wrong identity, and retain the candidate-versus-controller SHA regression from #354. Do not mark Phase 2 accepted in the foundation.
- After that successor is merged and active, use a separate evidence-only PR to exercise it, add verified artifacts for issues #351, #355, and #356, close those issues, and record final acceptance. Keep task-evaluation aliases fail closed until Phase 4, add no new protected context, and do not begin Phase 3 or paid/general task execution first. A merged PR alone remains insufficient runtime or live-configuration evidence.
