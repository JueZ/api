...
- Deploy Test `30704470979` accepted exact main `5f033da73e4fd24de2f5f41c1abba97159f4b56b`, including complete configuration, authenticated smoke, telemetry, ledger, and provenance. Any later merge requires new exact-current-main CI and Deploy Test evidence before production preparation or promotion.
