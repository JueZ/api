...
- Successor implementation commit `f3e3b89c6ec564963cc6a8c5367db72a3028626d` on `codex/agent-learning-trusted-verifier-v4` adds executable prevention for both findings while keeping ordinary PR CI tokenless and controller wiring out of scope. It is prepared local implementation only; the later exact reviewed head and all remote acceptance evidence remain pending. Issues #351, #355, #356, #359, #360, and #361 remain open; no waiver or passing proof exists.
