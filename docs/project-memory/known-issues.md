...
- PR #358 repair-attempt-1 head `9a63d1baab9957a6518ff1652fc5c08f5d8ac87d` passed all free aggregates, but review `31307836692` found duplicate-ledger-row and candidate-correlation history bypasses. Final repair implementation `eaeff6cc5ee5ecaa0dd584b3a0b5c98467a8c99d` adds executable prevention; it has no final remote acceptance yet and consumes the last permitted repair. Issues #351, #355, #356, #359, and #360 remain open; no waiver or passing proof exists.
