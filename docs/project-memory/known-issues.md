...
- PR #358 final head `90e69177d335ef372b4b0e876563bfad63c89380` passed all free aggregates, but review `31308451194` rejected missing authenticated workflow/job provenance for the latest current deployment. It closed unmerged after both repairs. Successor implementation `73de4db53d70089b2eb5a27db477e1ad53923014` is prepared without live controller wiring. Issues #351, #355, #356, #359, #360, and #361 remain open; no waiver or passing proof exists.
- PR #362 repair-attempt-1 head `62b466d33ae20f652d949ffe28d92361b5450276` passed all free aggregates, but review `31309478932` correctly found that Deployment API actor, `log_url`, and timing do not causally bind a deployment record to an authenticated job. Final repair `739cc1d622d2df1446d3a11b594d08d3d268230d` excludes that metadata from proof and uses exact reviewed workflow bytes plus GitHub's run-associated ledger artifact, job lifecycle, ledger identity, and live health. It has no remote acceptance yet and no further repair is allowed on this PR.
