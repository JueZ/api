...
- Status: PR pending; after deployment, retry a protected browser operation with a fresh tab or sign out/sign in once if MSAL has stale cached interaction state.
