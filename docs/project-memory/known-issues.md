...
- Keep ordinary PR CI tokenless. The next successor must retain every reviewed boundary, keep the artifact-bound workflow/job/ledger/runtime proof, distinguish implementation commits from authenticated exact reviewed heads, bind directly to runtime `GITHUB_WORKFLOW_SHA`, and authenticate that SHA against protected-main history. Issues #351, #355, #356, #359, #360, and #361 remain open; no waiver or passing proof exists.
