...
| bring.prepare-complete-items | bring | destructive | bring.complete | user | local, prod | required | required | POST /api/bring/lists/{listUuid}/mutations/prepare | bring_complete_item |
| bring.prepare-remove-items | bring | destructive | bring.remove | user | local, prod | required | required | POST /api/bring/lists/{listUuid}/mutations/prepare | bring_remove_item |
