...
app.http('bringItems', { methods: ['GET', 'POST', 'OPTIONS'], authLevel: 'anonymous', route: 'api/bring/lists/{listUuid}/items', handler: bringHandler });
...
app.http('bringRemoveItems', { methods: ['POST', 'OPTIONS'], authLevel: 'anonymous', route: 'api/bring/lists/{listUuid}/items/remove', handler: bringHandler });
